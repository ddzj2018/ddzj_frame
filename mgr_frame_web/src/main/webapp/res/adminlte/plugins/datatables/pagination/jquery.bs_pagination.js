        ...
        init: function(options) {
            ...
            return this.each(function() {
                ...
                if(settings.bootstrap_version == "3") {
                    ...
                    html += '<div style="margin-left:10px;" class="' + settings.navListContainerClass + '">';
                    ...
                    if(settings.showGoToPage && settings.visiblePageLinks < settings.totalPages) {
                        html += '<div style="margin-left:10px;" class="' + settings.navGoToPageContainerClass + '">';
                    ...
                    if(settings.showRowsPerPage) {
                        html += '<div style="margin-left:10px;" class="' + settings.navRowsPerPageContainerClass + '">';
                        html += '<div class="input-group">';
                    ...
                    if(settings.showRowsInfo) {
                        html += '<div style="float:right;height:34px;line-height:34px;" class="' + settings.navInfoContainerClass + '">';
                        html += '<div style="margin-left:10px;" id="' + rows_info_id + '" class="' + settings.navInfoClass + '"></div>';
                        html += '</div>';
                    }
                    ...
                    if((settings.showGoToPage && settings.visiblePageLinks < settings.totalPages) || settings.showRowsPerPage) {
                        ...
                        if(settings.showGoToPage && settings.visiblePageLinks < settings.totalPages) {
                            html += '<div style="margin-left:10px;" class="' + settings.navGoToPageWrapperClass + '">';
                            html += '<span class="add-on" title="' + rsc_bs_pag.go_to_page_title + '"><i class="' + settings.navGoToPageIconClass + '"></i></span>';
                            html += '<input id="' + goto_page_id + '" type="text" class="' + settings.navGoToPageClass + '" title="' + rsc_bs_pag.go_to_page_title + '">';
                            html += '</div>';
                        }
                        if(settings.showRowsPerPage) {
                            html += '<div style="margin-left:10px;" class="' + settings.navRowsPerPageWrapperClass + '">';
